...
repos = {
    "https://raw.githubusercontent.com/WantedGang/WG-TRepo/master/plugins.json": "TRepo"
}
...
print("Eklentiler repodan çekiliyor...")
...
print("\n--- Repo gezildi ---")
print(f"Repodan çekilen toplam ham eklenti sayısı (all_plugins_raw): {len(all_plugins_raw)}")
...
print("\nRepo özelindeki dosyalar (mevcut/yeni) oluşturuluyor...")
...
print("Repo özelindeki dosyalar tamamlandı.")
